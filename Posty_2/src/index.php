...
<head>
    ...
    <style>
        * {
        ...
        body:has(.create-post.active) .dark-overlay {
            z-index: 1;
            opacity: 1;
        }
...
<body>
    ...
    <div class="create-post active" onclick="createPost(event)">
        <div class="standart">
            ...
            <form action="#" method="post" enctype="multipart/form-data" id="post-form">
                ...
                <div class="media">
                    <div class="left">
                        ...
                        <input type="file" id="insert-img" name="imgToUpload[]" style="display: ;" multiple>
  ...
  <circle class="path" cx="25" cy="25" r="20" fill="none" stroke-width="5"></circle>
    ...
    <script>
        ...
        document.getElementById('post-form').addEventListener('submit', function (event) {
            ...
            xhr.onload = function () {
                if (xhr.status === 200) {
                    console.log('Erfolgreich gepostet:', xhr.responseText);
                } else {
